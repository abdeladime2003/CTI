...
if (NOT "OFF")
  set(Broker_DIR "/home/abdo/Cti_Project/zeek-6.0.2/build/auxil/broker" CACHE
...
if (NOT TARGET Zeek::BinPAC)
    ...
    set_property(TARGET Zeek::BinPAC PROPERTY
                 IMPORTED_LOCATION "/home/abdo/Cti_Project/zeek-6.0.2/build/auxil/binpac/src/binpac")
endif ()
...
if (NOT TARGET Zeek::BifCl)
    ...
    set_property(TARGET Zeek::BifCl PROPERTY
                 IMPORTED_LOCATION "/home/abdo/Cti_Project/zeek-6.0.2/build/auxil/bifcl/bifcl")
endif ()
