...
//
// This file was automatically generated from /home/abdo/Cti_Project/zeek-6.0.2/src/DebugCmdInfoConstants.in
// DO NOT EDIT.
//
...
void init_global_dbg_constants () {

	{
		...
		info = new DebugCmdInfo(dcInvalid, names, 1, false, "This function should not be called",
		                                      false);
...

	{
		...
		info = new DebugCmdInfo(dcStep, names, 2, true, "Step to following statements, stepping into function calls",
		                                      true);
		g_DebugCmdInfos.push_back(info);
	}
