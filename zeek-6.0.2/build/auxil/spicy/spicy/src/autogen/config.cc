...
void Configuration::init(bool use_build_directory) {
    ...
    spicyc = (uses_build_directory ? "/home/abdo/Cti_Project/zeek-6.0.2/build/auxil/spicy/bin/spicyc" : "/usr/local/zeek/bin/spicyc");
    ...
    if ( auto path = std::getenv("SPICY_PATH") ) {
        ...
        library_paths = flatten({".", prefix("!INSTALL!/usr/local/zeek/share/spicy !BUILD!/home/abdo/Cti_Project/zeek-6.0.2/auxil/spicy/spicy/lib", "", installation_tag)});
    }
    ...
    runtime_cxx_include_paths =
        hilti::util::transform(hilti::util::split(
                                   prefix("!INSTALL!/usr/local/zeek/include !BUILD!/home/abdo/Cti_Project/zeek-6.0.2/auxil/spicy/spicy/runtime/include !BUILD!/home/abdo/Cti_Project/zeek-6.0.2/build/auxil/spicy/include", "", installation_tag)),
    ...
    toolchain_cxx_include_paths =
        hilti::util::transform(hilti::util::split(
                                   prefix("!INSTALL!/usr/local/zeek/include !BUILD!/home/abdo/Cti_Project/zeek-6.0.2/auxil/spicy/spicy/toolchain/include !BUILD!/home/abdo/Cti_Project/zeek-6.0.2/build/auxil/spicy/include", "", installation_tag)),
                               [](auto s) { return hilti::rt::filesystem::path(s); });
    ...
    runtime_cxx_flags_debug = flatten({prefix("!INSTALL!/usr/local/zeek/include !BUILD!/home/abdo/Cti_Project/zeek-6.0.2/auxil/spicy/spicy/runtime/include !BUILD!/home/abdo/Cti_Project/zeek-6.0.2/build/auxil/spicy/include", "-I", installation_tag),
                                       prefix("", "", installation_tag)});

    runtime_cxx_flags_release = flatten({prefix("!INSTALL!/usr/local/zeek/include !BUILD!/home/abdo/Cti_Project/zeek-6.0.2/auxil/spicy/spicy/runtime/include !BUILD!/home/abdo/Cti_Project/zeek-6.0.2/build/auxil/spicy/include", "-I", installation_tag),
                                         prefix("", "", installation_tag)});
